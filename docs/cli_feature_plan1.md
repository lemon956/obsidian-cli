...
Hermes 在 Inbox/Hermes 下拥有完整 HTTP/WebDAV 方法权限
Hermes 不能修改 Notes / Projects / Troubleshooting / Index 等正式目录
Hermes 不能删除、移动、重命名、覆盖正式目录中的笔记
```
...
GET / HEAD / OPTIONS / PROPFIND / PUT / MKCOL / DELETE / MOVE / COPY / PROPPATCH / LOCK / UNLOCK 允许访问 /Inbox/Hermes/
PUT / MKCOL / DELETE / MOVE / COPY / PROPPATCH / LOCK / UNLOCK 在 /Inbox/Hermes/ 之外禁止
```
